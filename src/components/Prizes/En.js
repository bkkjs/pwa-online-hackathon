      ...
      <div className="container">
        <div className="content">
          ...
          <div className="columns">
            <div class="column"><h2 className="title is-5 prize-title">The Winner</h2>
            <ul>
            ...
            <div class="column">
              <h2 className="title is-5 prize-title">1st Runnerup</h2>
              <ul>
            ...
            <div class="column">          
              <h2 className="title is-5 prize-title">2nd Runnerup</h2>
              <ul>
            ...
            <div class="column">
              <h2 className="title is-5 prize-title">Best Firebase Application</h2>
              <ul>
