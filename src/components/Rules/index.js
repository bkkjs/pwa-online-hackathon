    ...
    <section className="section">
      <div className="container">
        <div className="content">
          <h2 className="title is-4">กติกา</h2>
          <ol>
          ...
          <hr/>
          <h2 className="title is-4">กฎสำหรับ Web Application</h2>
          ...
          <hr/>
          <h2 className="title is-4">กฎของ Firebase</h2>
          ...
          <hr/>
          <h2 className="title is-4">การให้คะแนน</h2>
          ...
          <hr/>
          <h2 className="title is-4">คำถามที่พบบ่อย</h2>
